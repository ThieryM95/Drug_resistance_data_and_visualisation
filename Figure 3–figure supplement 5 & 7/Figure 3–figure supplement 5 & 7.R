...
# Load the data
Scenario_liste <- read.csv(file = "/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Data_summary_CSA_all.csv", header  = TRUE)
...
#---- Plot at low level of access to treatment (Figure_3_supplement_5) ----
...
ggsave("/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Figure 3–figure supplement 5.pdf",
       plot = PLOT, width = 11, height = 13, device="pdf", units = "cm", dpi = 300)


#---- Plot at high level of access to treatment (Figure_3_supplement_7) ----
