...
# load the data
data <- read.csv(file = "/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Data_first_order_indices_CSA_long.csv", header  = TRUE)
...
ggsave("/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Figure 3–figure supplement 3.pdf",
