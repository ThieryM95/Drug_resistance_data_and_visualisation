...
# Load the data
Precision_final <- read.csv(file = "/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Data_precision_GSA_all.csv", header  = TRUE)
...
D.labs <- c("Drug A", "Drug B", "Drug A + Drug B")
...
# save
ggsave("/scicore/home/penny/masthi00/WF_spread/Visulaise_results/Paper/Supplementary file 1–figure 7.pdf",
       plot = PLOT, width = 15, height = 6.5, device="pdf", units = "cm", dpi = 300)
